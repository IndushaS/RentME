...
### 5. copy and paste `http://127.0.0.1:5000/train` into a web browser to train the ML model for the first time
### 6. check to see `model loaded` in flask app terminal
### 7. Done! You may now enter addresses into the react web app and determine the optimal apartment for you.
